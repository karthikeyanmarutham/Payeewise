...
extension CategoryModelQuerySortBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByCreatedTime() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQuerySortThenBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByCreatedTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdTime', Sort.asc);
    });
  }
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, int, QQueryOperations> createdTimeProperty() {
    return QueryBuilder.apply(this, (query) {
